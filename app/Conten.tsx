...
const Conten: React.FC = () => {
  return (
    <div className="flex bg-gray-100 flex-col lg:flex-row items-center justify-center h-screen px-8 lg:px-16">
      {/* Container dengan background putih */}
      <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col lg:flex-row items-center justify-center">
        {/* Bagian Kiri: Gambar */}
